...
@Entity
@Table(name = "manufactured_movements")
public class ManufacturedMovementEntity extends BaseEntity {
    ...
    protected ManufacturedMovementEntity() {
    }

    public ManufacturedMovementEntity(
