...
@Entity
@Table(name = "material_stock_lots")
public class MaterialStockLotEntity extends BaseEntity {
    ...
    protected MaterialStockLotEntity() {
    }

    public static MaterialStockLotEntity create(
        ...
        MaterialStockLotEntity entity = new MaterialStockLotEntity();
