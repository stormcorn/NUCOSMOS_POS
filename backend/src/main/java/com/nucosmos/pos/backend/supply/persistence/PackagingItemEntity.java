...
public class PackagingItemEntity extends BaseEntity {
    ...
    protected PackagingItemEntity() {
    }

    public static PackagingItemEntity create(
            StoreEntity store,
            String sku,
            String name,
            String unit,
        ...
        PackagingItemEntity entity = new PackagingItemEntity();
        entity.store = store;
        entity.sku = sku;
        entity.name = name;
        entity.unit = unit;
