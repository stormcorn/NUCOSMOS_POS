...
@Entity
@Table(name = "packaging_stock_lots")
public class PackagingStockLotEntity extends BaseEntity {
    ...
    protected PackagingStockLotEntity() {
    }

    public static PackagingStockLotEntity create(
        ...
        PackagingStockLotEntity entity = new PackagingStockLotEntity();
