...
public interface MaterialItemRepository extends JpaRepository<MaterialItemEntity, UUID> {
    ...
    List<MaterialItemEntity> findAllByStore_CodeOrderByActiveDescNameAsc(String storeCode);

    Optional<MaterialItemEntity> findByIdAndStore_Code(UUID id, String storeCode);
